<?php
    ...
    if (isset($_POST['action'])) {
        ...
        if ($action === 'insert') {
            ...
            $insert = "INSERT INTO pelicula(nombre, sinopsis, fecha, img, generos) VALUES('$nombre','$sinopsis','$fechaEstreno','$img','$generos')";
            ...
            $update = "UPDATE pelicula SET nombre = '$nombre', sinopsis = '$sinopsis', fecha = '$fechaEstreno', img = '$img', generos = '$generos'  WHERE id_pelicula = '$id_pelicula'";
